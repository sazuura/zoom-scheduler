            ...
            <div class="order" style="flex:1;">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3" style="margin-bottom:12px;">
                        ...
                        <input type="text" id="id_user" name="id_user" class="form-control" value="{{ $newId ?? '' }}"
                            readonly
                    ...
                    <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:18px;">
                        ...
                        <button type="submit"
                            style="padding:8px 14px; background:#3C91E6; color:#fff; border:none; border-radius:6px;">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
